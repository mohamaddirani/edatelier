...
export const AIDressChatbot = () => {
  ...
  return (
    <Card className="fixed bottom-4 right-4 left-4 md:bottom-8 md:right-8 md:left-auto w-auto md:w-[400px] h-[85vh] md:h-[600px] max-h-[600px] md:rounded-2xl rounded-2xl flex flex-col shadow-2xl z-50 bg-background/95 backdrop-blur-xl border-border/50 overflow-hidden">
